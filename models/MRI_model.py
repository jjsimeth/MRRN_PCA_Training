...
class MRRN_Segmentor(BaseModel):
    ...
    def initialize(self, opt):
        ...
        #MRRN
        self.netSeg_A=networks.get_Incre_MRRN_deepsup(opt2.nchannels,1,opt2.init_type,self.gpu_ids, opt2.deeplayer)
    ...
    def cal_seg_loss (self,netSeg: Incre_MRRN_deepsup , pred: Tensor, gt: Tensor):
        """"""
        img=pred
        lmd = 1
        if(self.opt.model_type == 'deep'):
