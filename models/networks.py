...
from .incre_MRRN import Incre_MRRN_deepsup, Incre_MRRN_PreTrained_MultiModal


def get_Incre_MRRN_multimodal(n_channels=5,n_class=1,gpu_ids=[]):
    net_Unet=None
    use_gpu = len(gpu_ids) > 0
    if use_gpu:
        assert(torch.cuda.is_available())
    net_Unet=Incre_MRRN_PreTrained_MultiModal(n_channels, n_class)
