...
train_transforms = Compose(
    [
            ...
            RandGaussianNoised(keys=["img"], prob=0.15),
            RandGaussianSmoothd(keys=["img"], prob=0.15),
            ...
            CenterSpatialCropd(keys=["img","seg"], roi_size=[256, 256,-1]),
            ...
            RandAxisFlipd(keys=["img", "seg"], prob=0.25),
            
            RandRotated(keys=["img", "seg"], prob=1.0, range_x=1.0, range_y=0.0, range_z=0.0, mode=("bilinear", "nearest")),
            ...
            RandSpatialCropd(keys=["img", "seg"], roi_size=(128, 128, opt.nslices), random_size=False,random_center =True),
            Transposed(keys=["img", "seg"], indices=[3, 2, 1, 0]),
...
for epoch in range(num_epochs+1):
    ...
    for batch_data in train_loader:
        ...
        adc, labels = batch_data["img"].to(device), batch_data["seg"].to(device)
